  ...
  return (
    <section className="w-full lg:flex-1 bg-white p-3 md:p-4 rounded-3xl border border-slate-200 shadow-sm flex flex-col gap-3">
        ...
        <div className="bg-slate-100 p-1 rounded-2xl flex gap-1 text-[11px] font-bold">
          <button
            ...
            className={`px-3 py-1 rounded-xl transition-all cursor-pointer ${
              tipoPrecio === 'detal' ? 'bg-amber-500 text-white shadow-xs' : 'text-slate-600 hover:text-slate-900'
            }`}
          >
            Detal
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-xl transition-all cursor-pointer ${
              tipoPrecio === 'mayor' ? 'bg-amber-500 text-white shadow-xs' : 'text-slate-600 hover:text-slate-900'
            }`}
          >
            Al Mayor
          </button>
      ...
      <input
        ...
        className="w-full px-3 py-2.5 rounded-2xl border border-slate-300 bg-slate-50 text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 font-medium text-slate-800 placeholder:text-slate-400"
      />
          ...
          .map((prod) => {
            ...
            return (
              <button
                ...
                className="border border-slate-200 bg-slate-50 hover:bg-amber-50/40 hover:border-amber-400 rounded-2xl text-left flex flex-col justify-between p-2.5 md:p-3 transition-all hover:shadow-md cursor-pointer group active:scale-95"
              >
                <div>
                  ...
                  <h3 className="font-bold text-slate-900 text-xs leading-snug group-hover:text-amber-700 line-clamp-2">
                    {prod.nombre}
                  </h3>
                </div>
